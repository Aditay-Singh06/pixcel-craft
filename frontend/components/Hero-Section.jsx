    ...
    <div
      ...
      <div className="px-4 py-10 md:py-20">
        <h1
          ...
          {"Powerful Image Utilities for, PixelCraft"
            .split(" ")
            .map((word, index) => (
              <motion.span
                key={index}
        ...
        <motion.div
          ...
          <button
            className="w-50 transform rounded-lg bg-black px-6 py-2 font-medium text-white transition-all duration-300 hover:-translate-y-0.5 hover:bg-gray-800 dark:bg-white dark:text-black dark:hover:bg-gray-200">
          ...
          <button
            className="w-50 transform rounded-lg border border-gray-300 bg-white px-6 py-2 font-medium text-black transition-all duration-300 hover:-translate-y-0.5 hover:bg-gray-100 dark:border-gray-700 dark:bg-black dark:text-white dark:hover:bg-gray-900">
            <div className="flex items-center justify-center gap-2 text-md">
            View on GitHub
            <Github/>
            </div>
