...
export function FeaturesSectionDemo() {
  const features = [
    ...
    {
      title: "Optimization",
      description: "Automatically optimize images for the web without sacrificing quality.",
      icon: <Zap />,
    },
    {
      title: "Export Options",
      description: "Export images in multiple formats with customizable quality settings.",
      icon: <Download />,
    },
    {
