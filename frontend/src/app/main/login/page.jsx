        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="rounded-xl border border-gray-700 bg-black/50 p-6 shadow-2xl backdrop-blur">
            <div className="mb-8 text-center">
              <h1 className="text-2xl font-bold text-white-500">Welcome back</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <Link href="/forgot-password" className="text-xs text-white-400 hover:text-blue-600">
                      Forgot password?
                    </Link>
                  </div>
                  <Input
              ...
              <div className="space-y-4">
                <Button type="submit" className="w-full bg-blue-700 text-white hover:bg-blue-700">
                  Sign in
                ...
                <div className="relative flex items-center">
                  ...
                  <span className="mx-4 flex-shrink text-xs text-white-400">OR CONTINUE WITH</span>
                  <div className="flex-grow border-t border-gray-400"></div>
                </div>
