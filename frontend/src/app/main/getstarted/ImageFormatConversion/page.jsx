    ...
    <div className="flex min-h-screen bg-black text-white">
      ...
      <div className="flex-1 overflow-auto">
        ...
        <main className="max-w-5xl mx-auto px-6 py-8">
          ...
          The ImageFormatConverter component converts an image from its original format to a specified output format (PNG, JPEG, or WebP) directly in the browser using a canvas. It also renders a preview of the converted image. Ideal for lightweight image manipulation, optimization, or client-side previews before upload.
          </p>
...
{/* {`{ id?: number; name: string; designation: string; image: string }`} */}
                    ...
                    Source of the original image. Can be a URL or base64 data URI.
...
{/* {`{ id?: number; name: string; designation: string; image: string }`} */}
                    ...
                    <td className="py-3 px-4 text-gray-300">
                    Compression quality (0.0 to 1.0) for JPEG/WebP. Ignored for PNG.
...
{/* {`{ id?: number; name: string; designation: string; image: string }`} */}
                    ...
                    <td className="py-3 px-4">
                      <code className="text-xs bg-gray-800 px-2 py-1 rounded">Original width</code>
                    </td>
...
{/* {`{ id?: number; name: string; designation: string; image: string }`} */}
                    ...
                    <td className="py-3 px-4">
                      <code className="text-xs bg-gray-800 px-2 py-1 rounded">Original height</code>
                    </td>
