    ...
    <div className="flex min-h-screen bg-black text-white">
      ...
      <div className="flex-1 overflow-auto">
        ...
        <main className="max-w-5xl mx-auto px-6 py-8">
          <h1 className="text-3xl font-bold mb-2">Filters and Effects</h1>
          <p className="text-gray-400 mb-6">
            This component allows you to apply various filters and effects to
            images, such as grayscale, sepia, brightness, contrast, and blur.
          </p>
                ...
                <tbody>
                  <tr className="border-b border-gray-800">
                    ...
                    <td className="py-3 px-4 text-gray-300">
                      ...
                      string is not composed correctly—uses invalid syntax like{" "}
                      <code className="text-ms bg-gray-800 px-2 py-1 rounded">
                        grayscale({"grayscale"})
                      </code>
                    </td>
                    <td className="py-3 px-4 text-gray-300">
                      Construct the string properly (see corrected code below)
                    </td>
                  </tr>
                  <tr className="border-b border-gray-800">
                    ...
                    <td className="py-3 px-4 text-gray-300">
                      ...
                      is invalid or cross-origin error
                    </td>
                  </tr>
                  <tr className="border-b border-gray-800">
                    <td className="py-3 px-4">
                      Performance impact on large images
                    </td>
                    <td className="py-3 px-4 text-gray-300">
                      Too many CSS filters on large files
                    </td>
                    <td className="py-3 px-4 text-gray-300">
                      Recommend compressing or resizing large images before
                      applying filters
                    </td>
                  </tr>
                  <tr className="border-b border-gray-800">
                    <td className="py-3 px-4">Unsupported CSS filters</td>
                    <td className="py-3 px-4 text-gray-300">
                      Older browser versions or incomplete CSS support
                    </td>
                    <td className="py-3 px-4 text-gray-300">
                      Warn users and provide fallback styling or check browser
                      compatibility
                    </td>
                  </tr>
                  <tr>
                    <td className="py-3 px-4">Misconfigured filter values</td>
                    <td className="py-3 px-4 text-gray-300">
                      Accepting values out of valid range (e.g.,{" "}
                      <code className="text-ms bg-gray-800 px-2 py-1 rounded">
                        &nbsp;&nbsp;&nbsp;grayscale: 3
                      </code>{" "}
                      )
                    ...
                    <td className="py-3 px-4 text-gray-300">
                      Add prop validation or clamping to keep values in
                      supported ranges
                    </td>
                  </tr>
                </tbody>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-gray-900 rounded-lg p-6">
                ...
                <p className="text-gray-300 mb-4">
                  Users can preview filters like Instagram/Snapseed before
                  applying
                </p>
              ...
              <div className="bg-gray-900 rounded-lg p-6">
                ...
                <p className="text-gray-300 mb-4">
                  Simulate how images will look under different filters for ads
                  ...
                  <table className="w-full border-collapse">
                    ...
                    <tbody>
                      ...
                      <tr className="border-b border-gray-800">
                        ...
                        <td className="py-2 px-4 text-gray-300">
                          Improves performance when many filtered images are on
                          screen
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td className="py-2 px-4 text-gray-300">
                          Use low-res placeholder and swap
                        </td>
                        <td className="py-2 px-4 text-gray-300">
                          For perceived speed in slow connections
                        </td>
                      </tr>
                          <hr />
                      <tr>
                        ...
                        <td className="py-2 px-4 text-gray-300">
                          Greatly reduce file size with no visible loss in
                          quality
                        </td>
                      </tr>
                    </tbody>
